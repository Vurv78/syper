...
local VS_Control_Light = { f = { r = 156, g = 220, b = 254, a = 255 } } -- Variables
local VS_Control = { f = { r = 86, g = 156, b = 214, a = 255 } } -- Special keywords?

local VS_FunctionName = { f = { r = 220, g = 220, b = 170, a = 255 } } -- Yellow Func name
local VS_Keyword = { f = {r = 197, g = 134, b = 192, a = 255} }

-- Taken from VSCode.. here's a link I found that also has this theme.
-- https://github.com/eamodio/vscode-amethyst-theme/blob/main/themes/dark_plus.json
...
return {
	...
	[TOKEN.Identifier]          = VS_Control_Light, -- Variable
	[TOKEN.Other]               = {f = {r = 248, g = 248, b = 242, a = 255}}, -- Can't match anything, but isn't error.
	[TOKEN.Whitespace]          = {f = {r = 248, g = 248, b = 242, a = 255}},
	[TOKEN.Punctuation]         = {f = {r = 248, g = 248, b = 242, a = 255}},
	[TOKEN.Error]               = {f = {r = 244, g = 71, b = 61, a = 255}}, -- idk
	...
	[TOKEN.Argument]            = VS_Control_Light,	-- Args
